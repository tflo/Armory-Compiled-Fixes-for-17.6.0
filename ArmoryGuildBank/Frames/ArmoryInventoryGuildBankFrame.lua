--[[
    ...
    Revision: 244 2022-11-10T18:06:00Z
...
function ArmoryInventoryGuildBankFrame_OnLoad(self)
    ArmoryPanelTemplates_SetNumTabs(ArmoryInventoryFrame, 3);
    ArmoryPanelTemplates_UpdateTabs(ArmoryInventoryFrame);
    self.collapsedTabs = {};
end
...
function ArmoryInventoryGuildBankFrame_OnShow(self)
    ...
    ArmoryMoneyFrame_Update("ArmoryInventoryMoneyFrame", dbEntry and AGB:GetMoney(dbEntry) or 0);
...
function ArmoryInventoryFrame_OnShow(...)
    ...
    if ( guild and AGB:GetConfigIntegrate() ) then
        ...
        selected = ArmoryPanelTemplates_GetSelectedTab(ArmoryInventoryFrame) == 3;
    else
    ...
    if ( selected ) then
        ArmoryPanelTemplates_SetTab(ArmoryInventoryFrame, 3);
        ArmoryInventoryGuildBankFrame:Show();
    else
        ArmoryInventoryGuildBankFrame:Hide();
...
function ArmoryInventoryFrame_Update(...)
    if ( ArmoryPanelTemplates_GetSelectedTab(ArmoryInventoryFrame) == 3 ) then
        ArmoryInventoryGuildBankFrame_Update();
    else
