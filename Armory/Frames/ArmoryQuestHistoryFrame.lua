--[[
    ...
    Revision: 244 2022-11-10T16:40:45Z
...
function ArmoryQuestHistoryFrame_OnShow(self)
    self:GetParent().bottomInset:Hide();
    self:GetParent().Inset:SetPoint("BOTTOMRIGHT", self:GetParent(), "BOTTOMLEFT", PANEL_DEFAULT_WIDTH + PANEL_INSET_RIGHT_OFFSET, PANEL_INSET_BOTTOM_OFFSET);
...
function ArmoryQuestHistory_Update()
    ...
    -- ScrollFrame update
    FauxScrollFrame_Update(ArmoryQuestHistoryScrollFrame, numEntries, QUESTHISTORY_DISPLAYED, ARMORY_QUESTHISTORY_HEIGHT);
