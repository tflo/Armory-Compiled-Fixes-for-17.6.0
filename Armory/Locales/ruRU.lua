...
L["BINDING_NAME_ARMORY_CURRENCY"] = "Открыть окно валюты"
L["BINDING_NAME_ARMORY_INVENTORY"] = "Открыть инвентарь"
--[[Translation missing --]]
L["BINDING_NAME_ARMORY_PET"] = "Open pet frame"
--[[Translation missing --]]
L["BINDING_NAME_ARMORY_PVP"] = "Open PVP frame"
L["BINDING_NAME_ARMORY_QUEST"] = "Открыть журнал заданий"
L["BINDING_NAME_ARMORY_RAID"] = "Открыть окно рейда"
L["BINDING_NAME_ARMORY_REPUTATION"] = [=[Открыть окно репутации
Context: Назначить клавишу]=]
--[[Translation missing --]]
L["BINDING_NAME_ARMORY_SOCIAL"] = "Open social pane"
L["BINDING_NAME_ARMORY_SPELLBOOK"] = [=[Открыть книгу способностей
Context: Назначить клавишу]=]
L["BINDING_NAME_ARMORY_TALENT"] = [=[Открыть окно талантов
Context: Назначить клавишу]=]
L["BINDING_NAME_ARMORY_TOGGLE"] = "Показать\\скрыть Armory"
L["BINDING_NAME_ARMORY_TRADESKILL1"] = [=[Открыть основную профессию 1
Context: Назначить клавишу]=]
L["BINDING_NAME_ARMORY_TRADESKILL2"] = [=[Открыть основную профессию 2
Context: Назначить клавишу]=]
...
L["BINDING_NAME_NEXT_CHARACTER"] = "Выбрать следующего персонажа"
L["BINDING_NAME_PREVIOUS_CHARACTER"] = "Выбрать предыдущего персонаж"
