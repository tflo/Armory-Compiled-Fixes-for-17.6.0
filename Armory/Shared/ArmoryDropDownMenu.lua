--[[
    ...
    Revision: 224 2022-11-16T19:35:01Z
...
local DROPDOWNMENU_MINBUTTONS = 8;
ARMORY_DROPDOWNMENU_MAXBUTTONS = 8;
local DROPDOWNMENU_MAXLEVELS = 2;
local DROPDOWNMENU_BUTTON_HEIGHT = 16;
local DROPDOWNMENU_BORDER_HEIGHT = 15;
-- The current open menu
ARMORY_DROPDOWNMENU_OPEN_MENU = nil;
-- The current menu being initialized
local DROPDOWNMENU_INIT_MENU = nil;
...
local DROPDOWNMENU_SHOW_TIME = 2;
...
function ArmoryDropDownMenu_Initialize(frame, initFunction, displayMode, level, menuList)
    ...
    DROPDOWNMENU_INIT_MENU = frame:GetName();

    -- Hide all the buttons
    local button, dropDownList;
    for i = 1, DROPDOWNMENU_MAXLEVELS, 1 do
    ...
    frame:SetHeight(DROPDOWNMENU_BUTTON_HEIGHT * 2);
...
function ArmoryDropDownMenu_StartCounting(frame)
    if ( frame.parent ) then
        ...
        frame.showTimer = DROPDOWNMENU_SHOW_TIME;
        frame.isCounting = 1;
    end
end
...
function ArmoryDropDownMenu_CreateFrames(level, index)
    ...
    while ( level > DROPDOWNMENU_MAXLEVELS ) do
        DROPDOWNMENU_MAXLEVELS = DROPDOWNMENU_MAXLEVELS + 1;
        local newList = CreateFrame("Button", "ArmoryDropDownList"..DROPDOWNMENU_MAXLEVELS, nil, "ArmoryDropDownListTemplate");
        newList:SetFrameStrata("FULLSCREEN_DIALOG");
        newList:SetToplevel(1);
        newList:Hide();
        newList:SetID(DROPDOWNMENU_MAXLEVELS);
        newList:SetWidth(180)
        newList:SetHeight(10)
        for i=DROPDOWNMENU_MINBUTTONS+1, ARMORY_DROPDOWNMENU_MAXBUTTONS do
            local newButton = CreateFrame("Button", "ArmoryDropDownList"..DROPDOWNMENU_MAXLEVELS.."Button"..i, newList, "ArmoryDropDownMenuButtonTemplate");
            newButton:SetID(i);
        end
    end
    ...
    while ( index > ARMORY_DROPDOWNMENU_MAXBUTTONS ) do
        ...
        for i=1, DROPDOWNMENU_MAXLEVELS do
...
function ArmoryDropDownMenu_AddSpace(level)
    local spaceInfo = {
        hasArrow = false,
        isTitle = true,
        notCheckable = true,
    ...
    ArmoryDropDownMenu_AddButton(spaceInfo, level);
end
...
function ArmoryDropDownMenu_AddButton(info, level)
    ...
    local xPos = 5;
    local yPos = -((button:GetID() - 1) * DROPDOWNMENU_BUTTON_HEIGHT) - DROPDOWNMENU_BORDER_HEIGHT;
    ...
    if ( not frame ) then
        frame = _G[DROPDOWNMENU_INIT_MENU];
    end
    ...
    listFrame:SetHeight((index * DROPDOWNMENU_BUTTON_HEIGHT) + (DROPDOWNMENU_BORDER_HEIGHT * 2));
...
function ArmoryDropDownMenu_ResetValues()
    ...
    DROPDOWNMENU_MINBUTTONS = 8;
    ARMORY_DROPDOWNMENU_MAXBUTTONS = 8;
    DROPDOWNMENU_MAXLEVELS = 2;
    DROPDOWNMENU_BUTTON_HEIGHT = 16;
    DROPDOWNMENU_BORDER_HEIGHT = 15;
    -- The current open menu
    ARMORY_DROPDOWNMENU_OPEN_MENU = nil;
    -- The current menu being initialized
    DROPDOWNMENU_INIT_MENU = nil;
    -- Current level shown of the open menu
    ARMORY_DROPDOWNMENU_MENU_LEVEL = 1;
    -- Current value of the open menu
    ARMORY_DROPDOWNMENU_MENU_VALUE = nil;
    -- Time to wait to hide the menu
    DROPDOWNMENU_SHOW_TIME = 2;
    -- Default dropdown text height
    ARMORY_DROPDOWNMENU_DEFAULT_TEXT_HEIGHT = nil;
...
function ArmoryCloseDropDownMenus(level)
    ...
    for i=level, DROPDOWNMENU_MAXLEVELS do
...
function ArmoryDropDownMenu_GetCurrentDropDown()
    ...
    elseif ( DROPDOWNMENU_INIT_MENU ) then
        return _G[DROPDOWNMENU_INIT_MENU];
    end
