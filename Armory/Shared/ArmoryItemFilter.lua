--[[
    ...
    Revision: 205 2022-11-15T19:01:10Z
...
local auctionItemClasses = {
    ...
    { AUCTION_CATEGORY_ITEM_ENHANCEMENT, Enum.ItemClass.ItemEnhancement },
    ...
    { AUCTION_CATEGORY_BATTLE_PETS, Enum.ItemClass.Battlepet },
