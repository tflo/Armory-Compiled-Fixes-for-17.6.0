--[[
    ...
    Revision: 1 2023-01-29T14:53:22Z
...
Armory.options = {
    ...
    ARMORY_CMD_SET_MAILCHECKVERBOSE = {
        type = "toggle",
        set = function(value) Armory:SetConfigMailVerboseCount(value and value ~= "0"); end,
        get = function() return Armory:GetConfigMailVerboseCount(); end,
        disabled = function() return not Armory:HasInventory(); end,
        default = false
    },
...
function Armory:SetConfigMailVerboseCount(on)
    self:Setting("General", "MailVerboseCount", on);
end

function Armory:GetConfigMailVerboseCount()
    return self:Setting("General", "MailVerboseCount") or nil;
end
